...
export type SocialNetwork = S["SocialNetwork"];
export type SocialLink = S["SocialLink"];
export type SocialHandle = S["SocialHandle"];
...
export type Review = S["ReviewView"];
export type ReviewSummary = S["ReviewSummary"];
export type OwnReview = S["OwnReviewView"];
export type ModeratedReviewPage = S["ModeratedReviewPage"];
export type ModeratedReview = S["ModeratedReviewView"];
export type ProviderReviewPage = S["ProviderReviewPage"];
export type ProviderReview = S["ProviderReviewView"];
export type ProviderPreview = S["ProviderPreviewView"];
